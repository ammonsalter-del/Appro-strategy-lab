...
The Appropriation Strategy Lab is a client-side educational application that runs entirely in the user's browser. It does not collect, transmit, or store any personal data on external servers.
...
If you discover a security vulnerability in the Appropriation Strategy Lab, please report it responsibly:
